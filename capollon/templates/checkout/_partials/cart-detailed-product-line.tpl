...
<div class="product-line-grid">
  ...
  <div class="block-image product-line-grid-left col-md-3 col-xs-4">
  ...
  <div class="product-line-grid-right product-line-actions col-md-5 col-xs-12">
    <div class="groupe-actions row">
      <div class="col-md-10 col-xs-6">
        <div class="parent-input2 row">
          <div class="parent-input col-md-6 col-xs-6 qty">
      ...
      <div class="col-md-2 col-xs-2 text-xs-right">
        <div class="cart-line-product-actions">
          ...
          >
            {if empty($product.is_gift)}
              <i class="trash-product material-icons float-xs-left"></i>
            {/if}
          </a>
